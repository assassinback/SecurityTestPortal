...
<head>
  ...
  <link rel="icon" type="image/png" href="assets/img/njkhn.png">
  <title>
        <?php
          echo $page_name;
...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header_logo">
      <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i>
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html " target="_blank">
        <img src="assets/img/njkhn.png" class="navbar-brand-img h-100" alt="main_logo">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link " href="./pages/tables.html">
            ...
            <span class="nav-link-text ms-1">Lookout</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link " href="./pages/tables.html">
            ...
            <span class="nav-link-text ms-1">Fake Mailer</span>
          </a>
        </li>
        <li class="nav-item">
    ...
    <div class="sidenav-footer mx-3 ">
      <div class="card card-plain shadow-none" id="sidenavCard">
        ...
        <div class="card-body text-center p-3 w-100 pt-0">
          <div class="docs-info">
            ...
            <p class="text-xs font-weight-bold mb-0"><?php  echo $_SESSION["username"]; ?></p>
          </div>
        </div>
      </div>
      ...
      <div class="card card-plain shadow-none" id="sidenavCard">
        ...
        <div class="card-body-power text-center p-3 w-60 pt-0">
          <div class="power_off">
            <button type="submit" style="border:transparent;background-color:transparent;"><img class="w-50 mx-auto" src="assets/img/illustrations/power-off.png" alt="sidebar_illustration">
</button>
          </div>
        </div>
      </div>
